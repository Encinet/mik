...
public class ServerLinksModule {
    ...
    public void register() {
        ...
        serverLinks.addLink(ServerLinks.Type.WEBSITE, URI.create("https://mcmik.top"));
        serverLinks.addLink(ServerLinks.Type.COMMUNITY_GUIDELINES, URI.create("https://mcmik.top/wiki"));
